                ...
                <div class="col-10">
                   <div class="card mb-5 mt-5" >
                       <h4 class="card-title p-2 text-center bg-danger text-white">Registration Form</h4>
                           <div class="card-body">
                                 <form  class="row g-3" action="apply.php" method="post">
                                 <div class="mb-2 col-md-4">
                                
       <label for="prefix" class="form-label">Prefix</label>
       <select class="form-select" aria-label="Default select example" id="prefix" name="prefix" required>
  <option selected><small class="text-muted" >Select</small></option>
  ...
  <option value="Mrs.">Mrs.</option>
   ...
   <div class="mb-2 col-md-8">
       ...
       <div class="mb-2 col-md-6">
           ...
           <input type="text" id="username" class="form-control" name="username" value=" <?php  echo $_SESSION['username']; ?>" required> 
       </div>
   
       
           <div class="mb-2 col-md-6">
               <label for="email" class="form-label">Email</label>
               <input type="email" id="email" class="form-control" name="email"  value=" <?php  echo $_SESSION['email']; ?>" required > 
           </div>
